...
func WatchForChanges(clientSet *kubernetes.Clientset, namespace, configmapName string, mutex *sync.Mutex) {
	for {
...
// func UpdateSettingsFiles(volumePath, settingKey, settingValue string) {
//
// }
